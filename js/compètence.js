...
const compètences_technique = document.querySelector(".section_competence_technique");
...
image_css_html.addEventListener("click", () => {
  ...
  compètences_technique.style.backgroundImage = "url('https://images.unsplash.com/photo-1461749280684-dccba630e2f6?q=80&w=1169&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')";
  
});
window.addEventListener("click", (event) => {
 if( event.target===image_js || event.target===image_vue || event.target===image_bootstrap || event.target===image_json || event.target===image_sass){
    competence_html.style.display = "none";
...
image_js.addEventListener("click", () => {
  ...
  compètences_technique.style.backgroundImage= "url('https://images.unsplash.com/photo-1515879218367-8466d910aaa4?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"
});
window.addEventListener("click", (event) => {
    if( event.target=== image_css_html || event.target===image_vue || event.target===image_bootstrap || event.target===image_json || event.target===image_sass){
      competence_js.style.display = "none";
...
image_vue.addEventListener("click", () => {
  ...
  compètences_technique.style.backgroundImage = "url(' https://images.unsplash.com/photo-1542831371-29b0f74f9713?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')";
});
window.addEventListener("click", (event) => {
  if( event.target=== image_css_html || event.target===image_js || event.target===image_bootstrap || event.target===image_json || event.target===image_sass){
    competence_vue.style.display = "none"; 
...
image_bootstrap.addEventListener("click", () => {
  ...
  compètences_technique.style.backgroundImage = "url(' https://images.unsplash.com/photo-1529101091764-c3526daf38fe?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mzl8fGNvZGluZ3xlbnwwfHwwfHx8MA%3D%3D')";
});
window.addEventListener("click", (event) => {
  if( event.target=== image_css_html || event.target===image_js || event.target===image_vue || event.target===image_json || event.target===image_sass){
    competence_bootstrap.style.display = "none";
...
image_json.addEventListener("click", () => {
  ...
  compètences_technique.style.backgroundImage = "url('https://images.unsplash.com/photo-1511376777868-611b54f68947?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')";
});
window.addEventListener("click", (event) => {
  if( event.target=== image_css_html || event.target===image_js || event.target===image_vue || event.target===image_bootstrap || event.target===image_sass){
    competence_json.style.display = "none";
...
image_sass.addEventListener("click", () => {
  ...
  compètences_technique.style.backgroundImage = "url(' https://images.unsplash.com/photo-1627398242454-45a1465c2479?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')";
});
window.addEventListener("click", (event) => {
    if( event.target=== image_css_html || event.target===image_js || event.target===image_vue || event.target===image_bootstrap || event.target===image_json){
        competence_sass.style.display = "none"; 
    }
})
